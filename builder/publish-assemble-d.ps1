...
try {
    Push-Location
    Set-Location Plugins/OITool.Plugin.LanguageEnhancement
    ./publish-d.ps1
}
finally {
    Pop-Location
...
try {
    ...
    Copy-Item -Path src/Unit/Plugins/OITool.Plugin.LanguageEnhancement/bin/Debug/net6.0/publish -Destination build/linux-arm64/server/plugins/OITool.Plugin.LanguageEnhancement -Recurse
    ...
    Copy-Item -Path src/Unit/Plugins/OITool.Plugin.LanguageEnhancement/bin/Debug/net6.0/publish -Destination build/linux-x64/server/plugins/OITool.Plugin.LanguageEnhancement -Recurse
    ...
    Copy-Item -Path src/Unit/Plugins/OITool.Plugin.LanguageEnhancement/bin/Debug/net6.0/publish -Destination build/osx-x64/server/plugins/OITool.Plugin.LanguageEnhancement -Recurse
    ...
    Copy-Item -Path src/Unit/Plugins/OITool.Plugin.LanguageEnhancement/bin/Debug/net6.0/publish -Destination build/win-arm64/server/plugins/OITool.Plugin.LanguageEnhancement -Recurse
    ...
    Copy-Item -Path src/Unit/Plugins/OITool.Plugin.LanguageEnhancement/bin/Debug/net6.0/publish -Destination build/win-x64/server/plugins/OITool.Plugin.LanguageEnhancement -Recurse
    ...
    Copy-Item -Path src/Unit/Plugins/OITool.Plugin.LanguageEnhancement/bin/Debug/net6.0/publish -Destination build/win-x86/server/plugins/OITool.Plugin.LanguageEnhancement -Recurse
